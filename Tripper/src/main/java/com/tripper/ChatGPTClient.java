...
/**
 * This class handles communication with the OpenAI ChatGPT API
 */
public class ChatGPTClient {

    // DO NOT SHARE OR USE THIS API KEY, I TRUST YOU GUYS :)
    ...
    public String getChatResponse(String conversationContext) {
        try {
            ...
            systemMsg.addProperty("content", "You are Tripper, a helpful and intelligent travel clothing planner chatbot. Provide detailed and friendly recommendations based on travel dates and weather conditions.");
